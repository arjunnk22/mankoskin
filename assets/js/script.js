...
;(function(factory){
    ...
    var Zippy = (function(element, settings){
      ...
      function _Zippy(element, settings){
        ...
        // This property will be incremented everytime a new Zippy carousell is created
           // It provides each carousell with a unique ID
    ...
    /**
       ...
       * Calls starter methods and associate the '.zippy-carousell' class
       * @params void
       * @returns void
       *
       */
     Zippy.prototype.init = function(){
      ...
      // Add a class so we can style our carousell
      this.$el.addClass('zippy-carousell');
      // Build out any DOM elements needed for the plugin to run
      // Eg, we'll create an indicator dot for every slide in the carousell
      this.build();
      // Eg. Let the user click next/prev arrows or indicator dots
      this.events();
      // Bind any events we'll need for the carousell to function
      this.activate();
  ...
  // Custom options for the carousell
  var args = {
